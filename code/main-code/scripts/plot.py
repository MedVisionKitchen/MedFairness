...
def plotimage(train, val, test_maj, test_min, ylabel, modelname, gam_d, gam_mmd):
...
def result_csv(train_auc, val_auc, testA_auc, testB_auc,  test_min_history, modelname, gam_d, gam_mmd):
